...
type Translatable struct {
	...
	I18nMessageValues *map[string]interface{}
}
...
func new(Err error, description string, coreError *error, httpCode int, i18n *Translatable) *CoreError {
...
func NewInternalServerError(description string, coreError *error, i18n *Translatable) *CoreError {
	return new(InternalServerError, description, coreError, 500, i18n)
}

func NewNotFoundError(description string, coreError *error, i18n *Translatable) *CoreError {
	return new(NotFoundError, description, coreError, 404, i18n)
}

func NewBadRequestError(description string, coreError *error, i18n *Translatable) *CoreError {
	return new(BadRequestError, description, coreError, 400, i18n)
}

func NewUnauthorizedError(description string, coreError *error, i18n *Translatable) *CoreError {
	return new(UnauthorizedError, description, coreError, 401, i18n)
}

func NewConflictError(description string, coreError *error, i18n *Translatable) *CoreError {
	return new(ConflictError, description, coreError, 409, i18n)
}

func NewValidationError(description string, coreError *error, i18n *Translatable) *CoreError {
